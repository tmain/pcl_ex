...
class ICCVTutorial
{
  public:
    ICCVTutorial (boost::shared_ptr<pcl::Keypoint<pcl::PointXYZRGB, pcl::PointXYZI> > keypoint_detector,
                  ...
                  boost::shared_ptr<pcl::SurfaceReconstruction<pcl::PointXYZRGBNormal> > surface_reconstructor,
  ...
  private:
    ...
    boost::shared_ptr<pcl::SurfaceReconstruction<pcl::PointXYZRGBNormal> > surface_reconstructor_;
...
main (int argc, char ** argv)
{
  ...
  boost::shared_ptr<pcl::SurfaceReconstruction<pcl::PointXYZRGBNormal> > surface_reconstruction;
